...
(Add new Site Token with Name format like yourname-token e.g., peter-token or kyndryl-token etc, please use your actual name for uniqueness and ease of identification/reference, copy and keep the UID value (saved it) once Site Token created for later use i.e., copy and paste)<br>
...
(Add two new Clusters with Name yourname-frontend and yourname-backend, e.g., kyndryl-frontend and kyndryl-backend, please use your actual name - yourname value for uniqueness and ease of identification/reference, keep the Name consistent and the same for K8s Cluster, App Stack, and the CE Cluster Name of the App Stack e.g., kyndryl-frontend and kyndryl-backend)<br>
...
(Add two new App Stack Sites with Name: yourname-frontend and yourname-backend, please use your actual name - yourname value for uniqueness and ease of identification/reference)<br>
...
1.9) Remote login (or login via web shell for UDF class) into two Customer Sites (Cloud or Edge) VMs to complete the CE configuration (E.g., ssh userid@vmipaddress with default password, a mandatory password change will be prompted - enter existing and desire new password, please obtain actual userid and password from lab assistant during lab time)<br>

1st CE<br>
![image](images/013ce1login.png)<br>
1st CE, enter/select following values and leave other values default<br>
(Latitude / Longtitude to chart CE location on F5XC map - enter your desire values, remember to change yourname-frontend to your actual name configured at previous step e.g., peter-frontend or kyndryl-frontend etc)<br>
| Field | Value | 
| --------------- | --------------- |
...
(Latitude / Longtitude to chart CE location on F5XC map - enter your desire values, remember to change yourname-backend to your actual name configured at previous step e.g., peter-backend or kyndryl-backend etc)<br>
| Field | Value | 
| --------------- | --------------- |
| Token | Site Token UID value copied earlier |
...
A live presentation on comparison before or during lab time.<br><br>
