...
2.3) Test connectivity from your laptop to the 1st CE K8s cluster with downloaded kubectl binary and Global Kubeconfig file, example of Linux command:<br>
./kubectl --kubeconfig ./ves_system_kyndryl-frontend_kubeconfig_global.yaml get all<br>
![image](images/018kubectlconnect1st.png)<br>

2.4) Test connectivity from your laptop to the 2nd CE K8s cluster with downloaded kubectl binary and Global Kubeconfig file and kubectl binary, example of Linux command:<br>
